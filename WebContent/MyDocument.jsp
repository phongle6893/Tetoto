...
<head>
    ...
    <!-- Custom CSS -->
    <link href="css/stylish-myDocument.css" rel="stylesheet">
    ...
    <!-- Services -->
      <div class="row text-center">
                <div class="col-lg-10 col-lg-offset-1">
                    <h2 style="color: #296">My Document</h2>
                    <hr class="small">
                    <div class="row " >
                        <div class="col-md-4 col-sm-6 col-md-offset-4">
                            <div class="service-item">
                                <span class="fa-stack fa-4x">
                                     ...
                                     <i class="fa fa-file fa-stack-1x text-primary" style="color:#ecf0f1"></i>
                                 </span >
    ...
    <section id="services" class="services bg-primary">
        <div class="container" >
         ...
         <div class="row" style="margin-top:40px">
            ...
            <!-- Document item-->
            <div class="row  " >
                <div class="editor-document-item col-lg-3 " glass="new">
                    <div class="doc-content">
                        <div class="add-document" ><a href="uploadDoc.jsp" style="color: #2c3e50;text-decoration: none;">New</a></div>

                    </div>
                    <div class="actions">
                        <div class="upload">
                             <span style="color:#e67e22"> Upload </span>
                            <input type="file" accept=".pdf" id="in" title="Upload a document">
                        </div>
                    </div>
                </div> <!--0/ item-upload-->
