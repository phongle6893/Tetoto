...
<head>
    ...
    <!-- Custom CSS -->
    <link href="css/stylish-myScore.css" rel="stylesheet">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="service-item">
                                <span class="fa-stack fa-4x">
                                     ...
                                     <i class="fa fa-star fa-stack-1x text-primary" style="color:#ecf0f1"></i>
                                 </span >
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td colspan="2">Marcus John Hall</td>
            <td>750</td>
          </tr>
           <tr>
            <td>
